...
using CloudyShop.Models.Payments;
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    order.Status = 1;//đang chuẩn bị / 2/đang giao hàng 3/Hoàn thành, 4/hủy
                    ...
                    foreach (var sp in cart.Items)
                    {
                        ...
                        strSanPham += "<td>" + CloudyShop.Common.Common.FormatNumber(sp.TotalPrice, 0) + "</td>";
                        strSanPham += "</tr>";
        ...
        public ActionResult VnpayReturn()
        {
            if (Request.QueryString.Count > 0)
            {
                ...
                if (checkSignature)
                {
                    ...
                    ViewBag.ThanhToanThanhCong = "Số tiền thanh toán (VND):" + CloudyShop.Common.Common.FormatNumber(vnp_Amount.ToString());
